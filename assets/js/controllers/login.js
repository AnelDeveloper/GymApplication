class Login {
  ...
  static do_Forgot_Password() {
    ...
    $.post("http://localhost/api/forgot", forgot_info).done(function (data) {
  ...
  static do_Register() {
    ...
    var register_info = {
      ...
      "protein": receiveprotein(),
      "GymPlace": receiveGymPlace()
...
function receiveprotein() {
  var protein = $("#register-protein").val();
  return protein;
}

function receiveGymPlace() {
  var place = $("#register-gym-place").val();
  return place;
}
